...
void sell_book(Shop &shop) {
  ...
  /** Locking the book_mutex*/
  book_mutex.lock();
  ++shop.sold_books;
  --shop.books_on_stock;
  /** Unlocking the book_mutex
  It protects the book variables
  Alexander Löwe, Sara Kemmler
  */
  book_mutex.unlock();
  /** Locking the item_mutex*/
  item_mutex.lock();
  ++shop.sold_items;
  /** Unlocking the item_mutex
  It protects the Item variables
  Alexander Löwe, Sara Kemmler
  */
  item_mutex.unlock();
...
void sell_toy(Shop &shop) {
  ...
  ++shop.sold_toys;
  --shop.toys_on_stock;
  /** Unlocking the toy_mutex
  It protects the Toy variables
  Alexander Löwe, Sara Kemmler
  */
  toy_mutex.unlock();
  /** Locking item_mutex*/
