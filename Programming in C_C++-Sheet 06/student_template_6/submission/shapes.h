...
public:
  ...
  std::string baseClass = "Base Class";
...
class Sphere final : public Shape {
  ...
  public:
    Sphere(Point3D center_, double radius_);
    Sphere();
...
class Cylinder final : public Shape {
  public:
  Cylinder(Point3D point, double radius, double height);
  Cylinder();
...
class Octahedron final : public Shape {
  ...
  public:
    Octahedron(Point3D point, double radius);
    Octahedron();
